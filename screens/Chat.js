...
import { TouchableWithoutFeedback,Keyboard, KeyboardAvoidingView, Platform, StyleSheet, Text, View } from 'react-native'
            ...
            >
                ...
                <>{/* ref={scrollViewRef} onContentSizeChange={() => scrollViewRef.current.scrollToEnd({ animated: true })} */}
                    ...
                    <View style={styles.footer}>
                        ...
                        placeholder="Chat Message" style={styles.textInput}/>
                        <TouchableOpacity activeOpacity={0.5} onPress={sendMessage} >
                            <Ionicons name="send" size={24} color="#254636"/>
                        </TouchableOpacity>
                    </View>
                </>
